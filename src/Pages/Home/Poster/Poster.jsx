            ...
            <div className="hero min-h-screen bg-fixed" style={{ backgroundImage: `url(${img})` }}>
                ...
                <div className="hero-content text-center text-neutral-content">
                    <div className="w-11/12 md:w-3/4 bg-white text-black rounded p-14">
                        ...
                        <button className="mt-2 hover:bg-slate-700 hover:text-white btn btn-outline bg-slate-200 text-black border-[#BB8506] border-0 border-b-4">Visit Our Food</button>
                    </div>
                </div>
            </div>
        </div>
